...
namespace Libgit2.Internals
{
    ...
    internal unsafe delegate result git_transport_cb(git_transport** transport, git_remote* owner, void* param);
    ...
    internal unsafe delegate result git_transport_push_cb(git_transport* transport, git_push* push, git_remote_callbacks* callbacks);
    ...
    internal unsafe delegate bool git_transport_is_connected_cb(git_transport* transport);
    internal unsafe delegate result git_transport_read_flags_cb(git_transport* transport, int* flags);
    internal unsafe delegate void git_transport_cancel_cb(git_transport* transport);
    internal unsafe delegate result git_transport_close_cb(git_transport* transport);
    internal unsafe delegate void git_transport_free_cb(git_transport* transport);
